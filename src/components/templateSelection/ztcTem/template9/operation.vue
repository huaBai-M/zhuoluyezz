<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom8 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom8>
		</div>
		<!--组件-->
...
import custom8 from"@/components/templateSelection/allTemplate/custom8"	
export default {
	data () {
		return{
			modelId:9,//模板ID
