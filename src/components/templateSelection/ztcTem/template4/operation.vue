<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom3 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom3>
		</div>
		<!--组件-->
...
import custom3 from"@/components/templateSelection/allTemplate/custom3"	
export default {
	data () {
		return{
			modelId:4,//模板ID
