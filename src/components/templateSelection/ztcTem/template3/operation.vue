<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom2 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom2>
		</div>
		<!--组件-->
...
import custom2 from"@/components/templateSelection/allTemplate/custom2"	
export default {
	data () {
		return{
			modelId:3,//模板ID
