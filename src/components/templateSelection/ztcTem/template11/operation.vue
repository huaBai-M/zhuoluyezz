<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom11 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom11>
		</div>
		<!--组件-->
...
import custom11 from"@/components/templateSelection/allTemplate/custom11"	
export default {
	data () {
		return{
			modelId:11,//模板ID
