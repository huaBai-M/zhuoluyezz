<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom4 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom4>
		</div>
		<!--组件-->
...
import custom4 from"@/components/templateSelection/allTemplate/custom4"	
export default {
	data () {
		return{
			modelId:5,//模板ID
