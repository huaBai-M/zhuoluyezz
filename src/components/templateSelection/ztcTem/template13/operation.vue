<template>
	<div>
					...
					<div class="col-md-6" >
						<p style="line-height: 35px;">
							...
							<el-radio-group v-model="Ifcolor"  v-bind:disabled="disabled1">
							 	    <el-radio label="#0b61e5">蓝色<span class="module13_color"></span></el-radio>
								    <el-radio label="#10b645">绿色<span class="module13_color"></span></el-radio>
								    <el-radio label="#fda403">橙色<span class="module13_color"></span></el-radio>
								    <el-radio label="#ca1204">红色<span class="module13_color"></span></el-radio>
								    <el-radio label="#cfa970">金色<span class="module13_color"></span></el-radio>
							</el-radio-group>
						</p>
					</div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom13 :productType="productType"  :Ifcolor="Ifcolor" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom13>
		</div>
		<!--组件-->
...
import custom13 from"@/components/templateSelection/allTemplate/custom13"	
export default {
	data () {
		return{
			modelId:13,//模板ID
