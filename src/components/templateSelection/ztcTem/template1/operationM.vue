<template>
	<div>
			...
			<div class="modulelist">
				<div class=" container text-center">
					<div style="padding-right:320px;">
						<a href="#/home/ztcoperation1" class="pc_abt">PC端制作</a>
		...
		<div id="modulehtml" ref="htmlBox">
			<currencyM :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></currencyM>
		</div>
		<!--组件-->
...
import currencyM from"@/components/templateSelection/allTemplate/currencyM"	
export default {
	data () {
		return{
			modelId:1,//模板ID
			modelType:1,//模板类型 0pc 1移动
			productType:1,//渠道类型
	...
	methods:{
		...
		obtainDate(){
			this.$xhr.get("/ztcPage/findPageEditParams",{
				...
				this.dataJson=res.data.paramMob
			}).catch((res)=>{
