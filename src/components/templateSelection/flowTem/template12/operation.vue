<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom12 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom12>
		</div>
		<!--组件-->
...
import custom12 from"@/components/templateSelection/allTemplate/custom12"	
export default {
	data () {
		return{
			modelId:12,//模板ID
