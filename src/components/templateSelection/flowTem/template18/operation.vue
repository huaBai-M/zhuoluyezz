<template>
	<div>
					...
					<div class="col-md-6" >
						<p style="line-height: 35px;">
							...
							<el-radio-group v-model="Ifcolor"  v-bind:disabled="disabled1">
									<el-radio label="#0169de">蓝色<span class="module13_color"></span></el-radio>
							 	    <el-radio label="#d72626">红色<span class="module13_color"></span></el-radio>
								    <el-radio label="#10b645">绿色<span class="module13_color"></span></el-radio>
								    <el-radio label="#4648ee">紫色<span class="module13_color"></span></el-radio>
							</el-radio-group>
						</p>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom18 :productType="productType" :Ifcolor="Ifcolor" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom18>
		</div>
		<!--组件-->
...
import custom18 from"@/components/templateSelection/allTemplate/custom18"	
export default {
	data () {
		return{
			modelId:18,//模板ID
	...
	created(){
		...
		this.modelType=this.$router.currentRoute.params.modelType;
