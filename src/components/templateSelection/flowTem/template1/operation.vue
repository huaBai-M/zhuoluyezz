<template>
	<div>
			...
			<div class="modulelist">
				<div class=" container text-center">
					<div style="padding-right:320px;">
						...
						<a href="#/home/operationM1" class="pc_abt">移动端制作</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="modulehtml" ref="htmlBox">
			<currencyPc :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></currencyPc>
		</div>
		<!--组件-->
...
import currencyPc from"@/components/templateSelection/allTemplate/currencyPc"	
export default {
	data () {
		return{
			modelId:1,//模板ID
...
//				console.log(res)
		...
		//提交或保存Ajax
		PreservationAjax(){
			console.log(this.$store.state.pageDate)
