					...
					<div class="col-md-6" >
						<p style="line-height: 35px;">
							...
							<el-radio-group v-model="Ifcolor"  v-bind:disabled="disabled1">
									<el-radio label="#02abab">青色<span class="module13_color"></span></el-radio>
							 	    <el-radio label="#4a546c">藏蓝色<span class="module13_color"></span></el-radio>
								    <el-radio label="#febb07">黄色<span class="module13_color"></span></el-radio>
								    <el-radio label="#b98651">木色<span class="module13_color"></span></el-radio>
								    <el-radio label="#e70012">红色<span class="module13_color"></span></el-radio>
								    <el-radio label="#6c4ffa">紫色<span class="module13_color"></span></el-radio>
							</el-radio-group>
						</p>
