<template>
	<div>
				...
				<div class="row">
					<div class="col-md-6" >
						<p style="line-height: 35px;">
							请选择模板主题色: <span style="padding:0 10px;"></span>
							<el-radio-group v-model="Ifcolor"  v-bind:disabled="disabled1">
							 	    <el-radio label="#813A1E">赤土色<span class="module13_color"></span></el-radio>
								    <el-radio label="#927463">古色<span class="module13_color"></span></el-radio>
								    <el-radio label="#03256C">蓝色<span class="module13_color"></span></el-radio>
								    <el-radio label="#831312">正红色<span class="module13_color"></span></el-radio>
								    <el-radio label="#842D33">朱红色<span class="module13_color"></span></el-radio>
								    <el-radio label="#1c9e6b">绿色<span class="module13_color"></span></el-radio>
							</el-radio-group>
						</p>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom15 :productType="productType" :Ifcolor="Ifcolor" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom15>
		</div>
		<!--组件-->
...
import custom15 from"@/components/templateSelection/allTemplate/custom15"	
export default {
	data () {
		return{
			modelId:15,//模板ID
	...
	methods:{
		...
		obtainDate(){
			this.$xhr.get("/page/findPageEditParams",{
				...
				this.Ifcolor=this.dataJson.background;
			}).catch((res)=>{
				console.log(res)
			})
		},
