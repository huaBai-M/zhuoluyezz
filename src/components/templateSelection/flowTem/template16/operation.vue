<template>
	<div>
		<div class="templataTopposition">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-16 text-right" style="padding-right: 30px;">
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom16 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom16>
		</div>
		<!--组件-->
...
import custom16 from"@/components/templateSelection/allTemplate/custom16"	
export default {
	data () {
		return{
			modelId:16,//模板ID
