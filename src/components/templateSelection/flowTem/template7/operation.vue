<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom6 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom6>
		</div>
		<!--组件-->
...
import custom6 from"@/components/templateSelection/allTemplate/custom6"	
export default {
	data () {
		return{
			modelId:10,//模板ID
