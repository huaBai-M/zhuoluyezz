<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom5 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom5>
		</div>
		<!--组件-->
...
import custom5 from"@/components/templateSelection/allTemplate/custom5"	
export default {
	data () {
		return{
			modelId:6,//模板ID
