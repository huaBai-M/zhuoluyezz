<template>
	<div>
		...
		<div id="modulehtml" ref="htmlBox" class="modulehtml">
			<custom7 :productType="productType" :dataJson="dataJson" :deleteNode="deleteNode"  @dataJsonFun="dataJsonFun"></custom7>
		</div>
		<!--组件-->
...
import custom7 from"@/components/templateSelection/allTemplate/custom7"	
export default {
	data () {
		return{
			modelId:8,//模板ID
