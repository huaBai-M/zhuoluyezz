<template>
	<div class="container">
	<div class="allTop">
		<!--all月<router-link to="/home/flowTop">flowTop</router-link>-->
		...
		<div class="box_middle">
			...
			<h1  v-show="!none">
				...
				本月排行
				<a href="#/home/topTotal" class="pull-right" style="margin-left:20px;">+总排行榜</a>
				<a href="#/home/historyTop" class="pull-right" style="margin-left:20px;">+历史中奖名单</a>
				<a href="#/home/allNew" class="pull-right" >+最新制作</a>
			</h1>
	...
	methods:{
		...
		imgBG(index){
	 	...
	 	dataSearch(){
	 		...
	 		this.$xhr.get("/pageShow/searchLLKMore",{
				 params: {
