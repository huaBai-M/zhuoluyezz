			...
			<el-row>
			  <el-col :span="4">
			  	<div class="ihomeBoxH_list">
			  		<img src="http://page-bucket.oiaqye7985.com/land-page/images/home/home1.jpg"/>
			  		<p>流量宝</p>
			  	</div>
			  </el-col>
			  <el-col :span="5">
			  	<a href="javascript:void(0)" @click="jump('3')"><!--1-->
			  		<ul>
			  ...
			  <el-col :span="5">
			  	<a href="javascript:void(0)" @click="jump('2')"><!--4-->
				  	<ul>
			  ...
			  <el-col :span="5">
			  	<a href="javascript:void(0)" @click="jump('0')"><!--0-->
				  	<ul>
...
<script>
	export default {
		...
		created(){
  		...
  		methods:{
  			obtain(){
  				this.$xhr.get("/pageShow/myWorkLlk",{
...
/*			jump(state){  
  			...
  			jump(state){
				...
				this.$router.push({
		            path: '/home/allFlowMaintain', 
		            name: 'allFlowMaintain',
		            params:{
		            	dataTop:{status:state}
		            }
		        })
